...
var weapon_list = [
    ...
    {name: "ウルサ・マヨル", lv:99, d: 2, delay: 86},
    {name: "ウルサ・マヨル", lv: 99, d: 31, delay: 140, memo: "強ワーグ系。時々2回攻撃。複数回攻撃発動率43.75%と仮定。", occ_p: 0.4375, occ_n: 2},
    {name: "ウルサ・マヨル", lv: 99, d: 2, delay: 140, memo: "弱ワーグ系。時々2-4回攻撃。複数回攻撃発動割合4:3:2:1と仮定。", occ_p: 0.4375, occ_n: 3},
    {name: "ウルサ・マヨル", lv: 99, d: 34, delay: 86, memo: "弱ワーグ系。DA+11%", double_attack: 0.11},
